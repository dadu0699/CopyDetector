...
break;
case 4:
 /*this.errorList.push(new Error(idError, this._$.first_line, this._$.first_column, yytext, '', 'Syntactic error')); */console.error('Syntactic error: ' + yytext + ', in the line ' + this._$.first_line + ' and column ' + this._$.first_column); this.idError++; 
break;
...
break;
case 7:
 this.$ = new ImportS($$[$0-1], this._$.first_line, this._$.first_column); 
break;
case 8:
 this.$ = new ClassS($$[$0-3], $$[$0-1], this._$.first_line, this._$.first_column); 
break;
case 9:
 this.$ = new ClassS($$[$0-2], null, this._$.first_line, this._$.first_column); 
break;
case 14:
 this.$ = new MethodS(Type.void, $$[$0-4], $$[$0-2], $$[$0], this._$.first_line, this._$.first_column); 
break;
case 15:
 this.$ = new MethodS($$[$0-5], $$[$0-4], $$[$0-2], $$[$0], this._$.first_line, this._$.first_column); 
break;
case 16:
 this.$ = new MethodS(Type.void, $$[$0-3], [], $$[$01], this._$.first_line, this._$.first_column); 
break;
case 17:
 this.$ = new MethodS($$[$0-4], $$[$0-3], [], $$[$01], this._$.first_line, this._$.first_column); 
break;
case 18:
 this.$ = Type.int; 
break;
...
break;
case 25:
 this.$ = new Param($$[$0-1], $$[$0], this._$.first_line, this._$.first_column) 
break;
case 26:
 this.$ = [$$[$0-2]]; 
break;
case 27:
 this.$ = []; 
break;
case 30: case 31: case 33: case 34: case 35: case 36: case 37: case 38: case 39: case 40: case 41: case 68: case 69: case 70: case 71: case 72: case 73: case 74: case 78:
 this.$ = $$[$0]; 
break;
case 32: case 50: case 83:
 this.$ = $$[$0-1]; 
break;
case 42:
...
break;
case 46:
this.$ = new Assignment($$[$0-2], $$[$0-1], this._$.first_line, this._$.first_column); 
break;
case 47:
this.$ = $$[$0-1];
break;
case 48: case 49:
this.$ = new Assignment($$[$0-1], $$[$0], this._$.first_line, this._$.first_column); 
break;
...
break;
case 75:
 this.$ = new InvokeMethod($$[$0-3], $$[$0-1]); 
break;
case 76:
 this.$ = new InvokeMethod($$[$0-2], null); 
break;
case 79:
 this.$ = new Print(Type.println, null, this._$.first_line, this._$.first_column); 
break;
case 80:
 this.$ = new Print(Type.println, $$[$0-1], this._$.first_line, this._$.first_column); 
break;
case 81:
 this.$ = new Print(Type.print, null, this._$.first_line, this._$.first_column); 
break;
case 82:
 this.$ = new Print(Type.print, $$[$0-1], this._$.first_line, this._$.first_column); 
break;
}
},
...
case 57:return 6;
break;
case 58: /*this.errorList.push(new Error(idError,  yy_.yylloc.first_line, yy_.yylloc.first_column, yy_.yytext, 'Unknown pattern', 'Lexical Error'));*/ console.error('Lexical Error: ' + yy_.yytext + ', in the line ' + yy_.yylloc.first_line + ' and column ' + yy_.yylloc.first_column); this.idError++; 
break;
}
},
